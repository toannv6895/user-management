...
- Amazon Cognito User Pools ([guide](https://docs.quarkiverse.io/quarkus-amazon-services/dev/amazon-cognitouserpools.html)): Connect to Amazon Cognito User Pools service
